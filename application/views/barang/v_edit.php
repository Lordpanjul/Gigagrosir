		...
		<div class="card-body">
			...
			<div class="row">
					...
					<div class="form-group">
						...
						<select name="id_kategori" class="form-control">
							...
							<?php foreach ($kategori as $key => $value) { ?>
								<option value="<?= $value->id_kategori ?>" <?= ($barang->id_kategori == $value->id_kategori) ? 'selected' : '' ?>>
									<?= $value->nama_kategori ?>
								</option>
							<?php } ?>
						</select>
				...
				<div class="col-sm-3">
					<div class="form-group">
						<label>MOQ</label>
						<input type="number" name="moq" min="1" class="form-control" placeholder="Minimum Order Qty" value="<?= $barang->moq ?>">
					</div>
				</div>
			</div>
